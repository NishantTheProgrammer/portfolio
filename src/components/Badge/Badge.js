        ...
        <Fragment>
            ...
            <div className={classes.badge}>
                <svg viewBox="0 0 91.66667 100" className="hexagon">
                    ...
                    <image class="badge-icon" xlinkHref="https://hrcdn.net/community-frontend/assets/badges/problem-solving-ecaf59a612.svg" x="50%" y="22" height="27" width="27" transform="translate(-13.5, 0)"></image>
                    <text class="badge-title" style={{textAlign: "center"}} x="10%" y="65.5" font-size="10">Problem Solving</text>
            ...
            <div>
                <h1 class={classes.badgeTitle}>HackerRank 5 start badge</h1>
                <div class={["btn", "demo", classes.btn].join(' ')} id="badgeBtn"><a href="https://www.hackerrank.com/NishantThePro">Visit on profile</a></div>
            </div>
        </div >
    </Fragment>
    );
